...
Scaffold buildMyScaffold(BuildContext context, Widget body, String title,
    {int bottomItemIndex = 0, bool isAppbar = true, int indexdrawer = 0, bool isNeedDrawer = true,
      bool isNeedBottomMenu = true, bool isNeedBottomBar = false,  FloatingActionButton floatingbutton}) {
  return Scaffold(
      appBar: isAppbar
          ? AppBar(
          ...
          BottomNavigationBar(
              ...
              items: <BottomNavigationBarItem>[
                BottomNavigationBarItem(
                  icon: Icon(custicon.MyFlutterApp.news),
                  title: Text('Главная'),
                ),
                BottomNavigationBarItem(
                ...
                BottomNavigationBarItem(
                  icon: Icon(custicon.MyFlutterApp.tickets),
                  title: Text('Билеты'),
                ),
                BottomNavigationBarItem(
