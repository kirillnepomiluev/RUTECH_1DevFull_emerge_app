...
class Panorama extends StatefulWidget {
  ...
  final TextEditingController controllerthis;
  final TextEditingController controllerthisY;
...
class _PanoramaState extends State<Panorama> with SingleTickerProviderStateMixin {
 ...
 TextEditingController textEditingControllerY;
  ...
  void initState() {
    ...
    textEditingController = widget.controllerthis;
    textEditingController.addListener(() {
     double latitudes =  double.parse(textEditingController.text);
     longitude = latitudes;
     setCameraTarget(latitude, latitudes);
    });
    textEditingControllerY = widget.controllerthisY;
    textEditingControllerY.addListener(() {
      double longy =  double.parse(textEditingControllerY.text);
      latitude=longy;
      setCameraTarget(longy, longitude);
    });
